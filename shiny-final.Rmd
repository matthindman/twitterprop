...
mydb <- dbConnect(RSQLite :: SQLite(), dbname = "/Users/Duckburg/Dropbox/2018stat/6289-consulting/project2/shiny-fakeaccounts/Data/fake.db")
pool <- dbPool(
  drv = RSQLite :: SQLite(),
...
server <- function(input, output, session) {
  ...
  ##Part 3:Sentiment Analysis-word cloud
    ...
    datasetInput <- reactive({
      ...
      tidy_tweet4 <- tweet4 %>%
        unnest_tokens(word, text)
      tidy_tweet4 <- tidy_tweet4 %>%
        anti_join(stop_words)
      tidy_tweet_id <- tidy_tweet4 %>%
        count(user_id, word)
